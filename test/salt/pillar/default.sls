...
prometheus:
  wanted:
    clientlibs:
      ...
      - rust
    comp:
      # List comps (ie, exporters) using underscores and
  ...
  pkg:
    ...
    clientlibs:
      ...
      golang:
        version: v1.6.0
    comp:
      # If you use OS packages in Debian's family, comps should have
      # a 'name' variable stating the name of the package (it's generally
      # something like `prometheus-comp-with-dashes-replacing-underscores`
      # ie,
      # node_exporter:
